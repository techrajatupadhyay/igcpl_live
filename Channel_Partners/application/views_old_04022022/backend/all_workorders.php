				    ...
				    <!--
                     <div class="card">
                        <div class="card-header">
                           <h5>All Work Orders by Sellers</h5>
								...
								<tbody> 
									...
									?>
									 <tr>
										...
										<td>											
											<a href="<?php echo base_url();?>/<?php echo $value->gem_workorder_doc; ?>" title="Workorder Document" target="_blank"><button class="btn btn-primary btn-outline-primary btn-round"><i class="fa fa-folder"></i>Document</button></a> 											
										</td>
										<td class="jsgrid-align-center ">
											<?php  
												if($usertype=="1")
												{  ?>																						
													<a href="<?php echo base_url();?>Admin/Assign_Buddy/<?php echo $value->sellerid; ?>/<?php echo $value->igcpl_workorder_id; ?>" title="Assign Buddy"><button class="btn btn-primary btn-outline-primary btn-round"><i class="fa fa-user-plus"></i>Assign Buddy</button></a>										   										   												
												<?php }  else if($usertype=="4") { ?>												
													<a href="#" title="view details"><button class="btn btn-primary btn-outline-primary btn-round"><i class="icofont icofont-eye-alt"></i></button></a>										   										   												
											<?php } ?>										
										</td>
									</tr>
									<?php } ?>
