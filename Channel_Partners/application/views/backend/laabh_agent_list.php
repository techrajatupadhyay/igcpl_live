                        ...
                        <div class="col-lg-4">
                           <div class="page-header-breadcrumb">
                              <ul class="breadcrumb-title">
                                 ...
                                 <li class="breadcrumb-item"><a href="#!">All Laabh Agents</a></li>                                 
                              </ul>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="page-body">
                     <div class="card">
                        <div class="card-header">
                           <h5>All Registered Laabh Agents</h5>
                        ...
                        <div class="card-block">
                           ...
                           <table  id="example" class="w-100 table table-striped table-bordered table-hover" width="100%">
                              ...
                              <tbody>
                                 <?php
                                    $i=0;
                                    foreach($laabhagentlist as $value): 
                                    $i++;
                                    ?>
                                 <tr>
                                    <td><?php echo $i; ?></td>
                                    ...
                                    */
                                    ...
                                    <td><?php echo $value->laabh_executive ?></td>
                                    <td><?php echo $value->contact_no ?></td>
                                    <td><?php echo $value->em_email?></td>
                                    <td><?php echo $value->present_full_address ?></td>
                                    <td><?php echo $value->present_pincode ?></td>
                                    <td>
                                       <!--<span class="icon icon-success"></span>-->
                                       <?php 
                                        if($value->approvel_status==0)
                                        {
                                            echo "<i class='fa fa-exclamation-circle Pending' aria-hidden='true'></i>";
                                        }
                                        if($value->approvel_status==1)
                                        {
                                            echo "<i class='fa fa-check-circle-o approved ' aria-hidden='true' ></i>";
                                        }
                                        if($value->approvel_status==2)
                                        {
									...
									if($user_type==1) { ?>
										<td class="jsgrid-align-center ">
										   <a href="<?php echo base_url();?>Laabh_agent/laabh_agent_details/<?php echo $value->user_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>                                      
										   <!--<a href="<?php echo base_url();?>Laabh_agent/edit_agent_details/<?php echo $value->user_id; ?>/<?php echo $value->laabh_executive; ?>/<?php echo $value->region; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
