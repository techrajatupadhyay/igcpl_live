...
class Logistice extends CI_Controller {
    ...
    public function all_workorders()
    {
       ...
       if ($this->session->userdata('user_login_access') == 1)
		{
			...
			$data['workorder'] = $this->logistic_model->get_all_workorders();

            $this->load->view('backend/new_header');
            $this->load->view('backend/new_sidebar'); 
            $this->load->view('backend/all_workorders',$data);
            $this->load->view('backend/new_footer');

            //$this->load->view('backend/new_data_table',$data);			
