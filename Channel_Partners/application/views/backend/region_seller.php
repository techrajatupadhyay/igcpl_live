                        ...
                        <div class="col-lg-4">
                           <div class="page-header-breadcrumb">
                              <ul class="breadcrumb-title">
                                 ...
                                 <li class="breadcrumb-item"><a href="#!">All Workorders </a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
      							...
      							<table  id="example" class="w-100 table table-striped table-bordered table-hover" width="100%">
      								...
      								<tbody> 
      									...
      									?>
      									 <tr>
      										...
      										<td><?php echo $value->present_full_address; ?>,<?php echo $value->present_city; ?>,<?php echo $value->district_first; ?>,<?php echo $value->present_pincode; ?>,</td>
                                    ...
                                    <td>
                                     ...
                                     <td class="jsgrid-align-center ">
                                       <a href="<?php echo base_url();?>Admin/SellerView/<?php echo $value->user_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>

                                       
                                      <!--  <a href="<?php echo base_url();?>Admin/Laabh_agent_details/<?php echo $value->user_id; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
                                       <a href="<?php echo base_url();?>Admin/Laabh_agent_details/<?php echo $value->user_id; ?>" title="Delete" onclick="confirm('Are Yoy Want To Delet This Laabh Agent!!!')" class="btn btn-sm btn-info waves-effect waves-light sellerdelet"><i class="fa fa-trash-o"></i></a> -->
                                    </td>
      									</tr>
      									<?php } ?>
      								</tbody>						
