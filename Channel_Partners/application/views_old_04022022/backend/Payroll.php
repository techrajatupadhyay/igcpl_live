                                ...
                                <div class="table-responsive ">
                                    <table id="example123" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           ...
                                           <?php $i =0; foreach($alllabbh_agent as $alllabbh_agent): ?>
                                            <tr>
                                                <td class="hide"><?php $i++; echo $i;?></td>
                                                <td><?php echo $alllabbh_agent->em_code; ?></td>
                                                <td><?php echo $alllabbh_agent->first_name.' '.$alllabbh_agent->last_name; ?></td>
                                                <td><?php echo $alllabbh_agent->month.' '.$alllabbh_agent->year; ?></td>
                                                <td><?php echo $alllabbh_agent->basic; ?></td>
                                                <td><?php echo $alllabbh_agent->loan; ?></td>
                                                <td><?php echo $alllabbh_agent->total_days; ?></td>
                                                <!--<td><?php echo $alllabbh_agent->addition; ?></td>-->
                                                <td><?php echo $alllabbh_agent->diduction; ?></td>
                                                <td><?php echo $alllabbh_agent->total_pay; ?></td>
                                                <td><?php echo $alllabbh_agent->paid_date; ?></td>
                                                <td><?php echo $alllabbh_agent->status; ?></td>
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?php echo base_url(); ?>payroll/invoice?Id=<?php echo $alllabbh_agent->pay_id; ?>&em=<?php echo $alllabbh_agent->emp_id; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-print"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
