...
<html lang="en">
   ...
   <body>
      ...
      <section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="assets/img/bg/bread-bg.jpg">
         ...
         <div class="container">
            <div class="ft-breadcrumb-content headline text-center position-relative">
               <h2>Marketing and Coordination</h2>
      ...
      <div class="container">
         ...
         <div class="ft-service-details-text-wrapper wrapper mb-3">

            <div class="row">
               <div class="col-md-6    w3-animate-left">
                  <img src="<?php echo base_url();?>assets/img/service/G-Laabh.jpg" class="w3-animate-left ">
               </div>
               ...
               <div class="col-md-5 ft-about-feature-list-item w3-center  w3-animate-right">
                  <h3 style="text-align: center;">Marketing and Coordination</h3>
                  <p class="" style="text-align:justify">Our G-Laabh division will be concerned with marketing and onboarding sellers registered on Gem. Its primary focus will be marketing and coordination with an aim to enhance effective delivery while reducing the business-cycle for sellers. It will on-board sellers and explain to them the facilities which they can avail by onboarding a channel-partner MoU with IGCPL. The marketing will also be extended to those sellers who are interested in selling outside Gem.</p>
               </div>
            </div>
         </div>
      </div>
