...
<div class="pcoded-content">
   <div class="main-body">
      <div class="page-wrapper">
               ...
               <div class="col-lg-4">
                  <div class="page-header-breadcrumb">
                     <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Onbord New Workorder Payment</a></li>
         ...
         <div class="card ">
            <?php  $this->load->view('backend/workorder_header',$sellerid); ?>
                        ...
                        <tbody>
                           ...
                           <tr class="checkbox">
                              <td style="text-align:center;"> 
                                 <input type="radio" name="registration"  id="chkYes<?php echo $pay_id; ?>" onclick="check_amount('<?php echo $pay_id; ?>')" class="checkoption" value="yes"  required >
                              </td>
                                       ...
                                       <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                          ...
                                          <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; "><strong>Payment Details:</strong><br/>
                                             <span class="mt-4">Order ID: <strong style="font-weight:bold;"><?php echo  $value->order_id?></strong></span><br/>
      									         ...
      									         <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; ">Mod of Payment : <strong> <?php echo $paymode;?></strong><br/>
                                          ...
                                          <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; ">Valid From: <strong><?php $newdate = date("Y-m-d"); echo $newdate; ?> </strong></p>
                                          <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; ">Valid Upto<strong><?php  $newdate = date("Y-m-d", strtotime(" +2 year")); 
                                                  echo $newdate;  ?></strong>
                                          </p>
