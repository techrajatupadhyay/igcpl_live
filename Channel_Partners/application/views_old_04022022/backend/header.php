...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="16x16" href="<?php echo base_url(); ?>assets/images/logo-icon.png">
  ...
  <!--   <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/date-picker.css">  -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/scss/icons/material-design-iconic-font/css/materialdesignicons.min.css"> 
</head>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/logo-icon.png" alt="DRI" class="DRI-logo" style="width:45px;"/>
                        </b>
                        <span>
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->first_name; ?></h5>
                                                     <span class="mail-desc"><?php echo $value->reason; ?></span> <span class="time"><?php echo $value->start_date; ?></span> </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                                    </li>
										...
										<li>
											<div class="dw-user-box">
												...
												<div class="u-text">
													...
													<span><?php echo $basicinfo->des_name ?></span><br>
