...
$info_right_column = '';
$info_left_column = '<br><br><br><div style="text-align: center;"><h3>TAX INVOICE<h3><div><hr>';
...
// Bill to
// $invoice_info_right4 = '';
// $invoice_info_left4 = '<div style="color:#424242;"><hr>';
// $invoice_info_left4 .='</div>';
// pdf_multi_row($invoice_info_left4, $invoice_info_right4, $pdf, ($dimensions['wk'] / 1) - $dimensions['lm']);
...
if (!empty($invoice->duedate)) {
    $invoice_info1 .= '<b style="color:#4e4e4e;">Invoice Number-' . $invoice_number . '</b> <br/>';
}
...
$left_info  = $swap == '1' ? $invoice_info : $invoice_info1;
$right_info = $swap == '1' ? $invoice_info1 : $invoice_info;

pdf_multi_row($right_info, $left_info, $pdf, ($dimensions['wk'] / 2) - $dimensions['lm']);

$organization_info = '<b>From</b> <br/>';
$organization_info .= '<div style="color:#424242;">';
$organization_info .= format_organization_info();
$organization_info .= '</div>';


$invoice_info2 = '<div style="color:#424242;"> <br/><b>Email id</b> - info@techsumsolution.com <br/><br/> <b>GSTIN</b> - 23AAICT0230G1ZV' ;
$invoice_info2 .='</div>';


$invoice_info_right3 = '';
$invoice_info_left3 = '<div style="color:#424242;"><hr>';
$invoice_info_left3 .='</div>';



$left_info1  = $swap1 == '1' ? $organization_info : $invoice_info2;
$right_info1 = $swap1 == '1' ? $invoice_info2 : $organization_info;

pdf_multi_row($invoice_info_left3, $invoice_info_right3, $pdf, ($dimensions['wk'] / 1) - $dimensions['lm']);

pdf_multi_row($right_info1, $left_info1, $pdf, ($dimensions['wk'] / 2) - $dimensions['lm']);
// The Table
