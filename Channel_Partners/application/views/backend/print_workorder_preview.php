...
<div class="print-area view card card-body">
   <div class="row " >
      <div class="col-md-2">
      ...
      <div class="col-md-8 col-sm-6 mou-heading" >
         <h2 class=" text-center">
            <span class="company_name ">Indigem Channel partners Private Limited</span>
         </h2>
      </div>
      <div class="col-md-2 ">
         <img src="<?php echo base_url()?>/assets/images/logo-icon-preview.png" class="logo-mou  mx-3">
      </div>
      <div class="col-md-12">
         <div class="bg-secondary">
            <h5 class="text-center text-white p-3 my-1">Acknowledgement For Indigem Channel partners Private Limited, 2022-2023</h5>
         </div>
      </div>
   </div>
   <div>
      <?php foreach($workorder as $value): ?>    
         <div class="row">
            <div class="col-md-6">
               <h5 class=" text-left"><b>Seller ID :</b> <span><?php echo $value->sellerid ?></span></h5>
            </div>
            <div class="col-md-6">
               <h5 class=" text-right" style="margin-top:-18px;"><b>Work Order ID :</b> <span> <?php echo $value->igcpl_workorder_id ?></span></h5>
            </div>
         </div>
         <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-10">
               <textarea type="text" class=" mb-1" readonly value="" style="float: right; width:70%; margin-top:-30px;"><?php echo $value->pick_location ?>, <?php echo $value->seller_city ?>, <?php echo $value->seller_district ?>
               </textarea>
            </div>
            ...
            <div class="col-md-10">
               <textarea type="text" class=" mb-1" style="float: right; width:70%; margin-top:-30px;" readonly value=""><?php echo $value->select_product ?>
               </textarea>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-md-10">
               <textarea class="mb-1" style="float: right; width:70%; margin-top:-30px;" readonly type="" name="" value=""><?php echo $value->consignee_address ?></textarea>
            </div>
            <div class="col-md-12">
         ...
         <!-- <div class="row">
            <div class="col-md-12">
               <button type="button" class="btn btn-info my-3" onclick="window.print()" style="float:right;"><i class="fa fa-print" aria-hidden="true"></i> Print</button>
