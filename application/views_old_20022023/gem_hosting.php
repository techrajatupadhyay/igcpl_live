      ...
      <section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="assets/img/bg/bread-bg.jpg">
         ...
         <div class="container">
            <div class="ft-breadcrumb-content headline text-center position-relative">
               <h2>Gem Hosting and Services</h2>
         ...
         <div class="ft-service-details-text-wrapper mb-3">
            <div class="row">
               <div class="col-md-6    w3-animate-left" >
                  <img src="<?php echo base_url();?>assets/img/service/G-Cafe_edited4.jpg">
               </div>
               ...
               <div class="col-md-5 ft-about-feature-list-item w3-center  w3-animate-right">
                  <h3 style="text-align: center;">Gem Hosting and Services</h3>
                  <p style="text-align:justify;">Our G-Café division shall establish facilitation kiosks/desktops in its allotted area in G-Plus stores. G-Café division shall consist of executives familiar with procedures on GeM. The main job of this division shall be to obtain piecemeal or periodic contracts from sellers and buyers to carry on gem hosting/sales for the sellers and gem procurement for the buyers. In addition, they shall assist new buyers/ sellers in gem registration and sample displays on gem platform.  </p>
               </div>
            </div>
         </div>
      </div>
