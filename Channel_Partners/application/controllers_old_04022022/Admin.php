...
class Admin extends CI_Controller
{
	...
	public function All_Managers()
    {
        ...
        {
            $user_id = $this->session->userdata('user_login_id');
            $data['employeeslist'] = $this->Admin_model->get_managers();
            $this->load->view('backend/new_header');
            $this->load->view('backend/new_sidebar'); 
	...
	public function Employee_Details($user_id,$user_type,$region)
    {
        if ($this->session->userdata('user_login_access') != False)
        {
            
            $data['Employee_Details'] = $this->Admin_model->get_employee_details($user_id,$user_type,$region);
            $this->load->view('backend/new_header');
            $this->load->view('backend/new_sidebar'); 
	...
	public function edit_employee_details($user_id,$user_type,$region)
    {
		
        if ($this->session->userdata('user_login_access') != False)
        {
   
            $data['Employee_Details'] = $this->Admin_model->get_edit_employee_details($user_id,$user_type,$region);
	...
	public function Employee_Approvel($user_id,$id,$region)
    {
        ...
        if ($this->session->userdata('user_login_access') != False)
        {
            ...
            {   
                ...
                $update = $this->Admin_model->approve_employee($user_id,$id,$region);
                $data['Details'] = $this->Admin_model->get_employee_details_mail($user_id,$id,$region);
