<html>
    <head>
		<meta charset="UTF-8">
		<title>IGCPL</title>
		<link rel="shortcut icon" href="<?php echo base_url();?>assets/img/logo/logo_new.png" type="image/x-icon"> 
						...
						<div class="ft-header-main-menu d-flex justify-content-end align-items-center">
							...
							<div class="ft-header-cta-btn">
								<li class="dropdown" style="list-style: none;">
									<a class="  " href=""> 
									<i class="fa fa-download" aria-hidden="true"></i><span> Brochure</span></a>
									<ul class="dropdown-menu clearfix">
										<li class=""><a href="<?php echo base_url();?>uploads/Brochure/Dec 22 Brochure Hindi.pdf" target="_blank" >In Hindi</a></li><br>
	                                    <li class=""><a href="<?php echo base_url();?>uploads/Brochure/Dec 22 Brochure English.pdf" target="_blank" >In English</a></li>											
									</ul>
								</li> 
							</div>
						</div>
							...
							<div class="mobile_menu_content">
								...
								<div class="m-brand-logo">
									<a href="<?php base_url();?>Home">
										<img src= "<?php echo base_url(); ?>assets/img/logo/logo_new.png" alt="" ></a>
								</div>
								<nav class="mobile-main-navigation  clearfix ul-li">
									<ul id="m-main-nav" class="navbar-nav text-capitalize clearfix">
										...
										<li class="dropdown">
											<a class="" > Download Brochure</a>
								            <ul class="dropdown-menu clearfix">
											    <li class="" ><a href="<?php echo base_url();?>uploads/Brochure/Dec 22 Brochure Hindi.pdf" target="_blank">In Hindi</a></li>
                                                <li><a href="<?php echo base_url();?>uploads/Brochure/Dec 22 Brochure English.pdf" target="_blank">In English</a></li>			
                                            </ul>
									    </li> 
									</ul>
								</nav>
