         ...
         <div class="page-wrapper">
            ...
            <div class="page-body">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <form action="<?php echo base_url();?>Laabh_agent/add_agent" method="post"enctype="multipart/form-data">
                                                   ...
                                                   <div class="box-body">
                                                        <div class="box-body box-profile">
															...
															<?php } else { ?> 
															 ...
															 <div class="input-group">
																<div class="input-group-addon">
																   <input type='file'accept="image/png,image/gif, image/jpeg, image/jpg"  required name="agent_image"onchange="proPic(this);"  <?php echo $em_image; ?> />
																</div>
															 </div>															
                                                   ...
                                                   <div class="box-body">
                                                      <div class="box-body box-profile">
														...
														<?php } else { ?>
                                                         ...
                                                         <div class="input-group">
                                                            <div class="input-group-addon">
                                                               <input type='file' accept="image/png,image/gif, image/jpeg, image/jpg"  name="agent_signature" required onchange="signature_pic(this);"/>
                                                            </div>
                                                         </div>
                                       ...
                                       <div class="row m-b-30">
									        <?php if(isset($Laabhagent_Details)) { ?>
												<div class="col-sm-3">
												 ...
												 <div class="input-group">
													<input type="file" accept=".pdf" id="file2_input"  class="form-control bg-white" placeholder="Phone"  id="contract_letter" name="contract_letter" value="<?php echo$resume ?>">
											...
											<?php } else { ?>
												<div class="col-sm-3">
												 <h4 class="sub-title">Contract Letter <span class="star"> * </span></h4>
												 <div class="input-group">
													<input type="file" accept=".pdf" id="file2_input"  required class="form-control bg-white" placeholder="Phone"  id="contract_letter" name="contract_letter" value="<?php echo$resume ?>">
													<span class="input-group-addon" id="basic-addon7"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>
												 </div>												 
												</div>											
											<?php } ?>
											...
											<?php if(isset($Laabhagent_Details)) { ?>
												<div class="col-sm-3">
												 ...
												 <div class="input-group">
													<input type="file" accept=".pdf" id="file2_input"   class="form-control bg-white" placeholder="Phone"  id="phone" name="resume" value="<?php echo$resume ?>">
													<span class="input-group-addon" id="basic-addon7"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>
												 </div>												 
