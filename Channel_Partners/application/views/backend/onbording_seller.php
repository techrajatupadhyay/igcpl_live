...
<li class="breadcrumb-item"><a href="#!">Onborded Sellers</a>
</li>
<!--
...
<div class="page-body">
	...
	<div class="card">
		<div class="card-header">
			<h5>All Onborded Sellers added by Laabh Executive</h5>
                     ...
                     <tr>
                        ...
                        <td>
                            <?php 
								...
								$user_name = $this->db->query("SELECT first_name  AS user_name FROM users where user_id='".$value->labh_emp_id."' limit 1");
				                $username= $user_name->result() ;
                                //print_r($this->db->last_query());
                                foreach($username as $name)
                                {
                                  echo  $user_name=$name->user_name;
                                }
                        ...
                        <td class="jsgrid-align-center ">
                           <!--<a href="<?php echo base_url();?>SellerRegister/SellerDetails/<?php echo $value->seller_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-folder-open-o"></i></a>-->
