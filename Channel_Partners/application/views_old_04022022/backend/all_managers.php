              ...
              <div class="row align-items-end">
                <div class="col-lg-8">
                  <div class="page-header-title">
                    <div class="d-inline"><br><h4> Branch Manager</h4></div>
                  </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="page-body">
              <div class="card">
                <div class="card-header">
                  <h5>All Registered Branch Managers</h5>
                    ...
                    <tr>
					  ...
					  <td>
					    <?php 
							...
							$seller_payment_details = $this->db->query("SELECT * FROM region WHERE region_id='".$row['region']."' and id='".$row['region_state']."' ");
							$pay_details= $seller_payment_details->result();
							//print_r($this->db->last_query());
							foreach($pay_details as $pay_det)
							{			
					  ...
					  <td>
					    <?php 
							...
							$seller_payment_details = $this->db->query("SELECT * FROM district_branch WHERE Districtcode='".$row['district_branch']."' ");
							$pay_details= $seller_payment_details->result();
							//print_r($this->db->last_query());
							foreach($pay_details as $pay_det)
							{			
					...
					<?php 
                        if($usertype==1) {  ?>
						  ...
						  <td class="jsgrid-align-center ">
							<a href="<?php echo base_url();?>Admin/Employee_Details/<?php echo $row['user_id']; ?>/<?php echo $row['user_type']; ?>/<?php echo $row['region']; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>
							<a href="<?php echo base_url();?>Admin/edit_employee_details/<?php echo $row['user_id']; ?>/<?php echo $row['user_type']; ?>/<?php echo $row['region']; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>							   
