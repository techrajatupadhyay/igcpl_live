         ...
         <div class="container-fluid whitebg myheader">
            <div class="row tophead">
               ...
               <div class="col-xs-12 col-sm-9 col-md-5 col-lg-6 logo company_name">
                  <a href="https://indigemcp.com/">
                     <h1 class="mt-4 text-right text-uppercase">INDIGEM CHANNEL PARTNERS  Pvt ltd</h1>
                  </a>
               </div>
                  ...
                  <div class="card-body">
                     <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 " data-toggle="modal" data-target="#seller">
                           <a href="#" class="seller logo_section" id="rgstrUser"><i class="fa fa-universal-access fa-3x" aria-hidden="true"></i><br>Seller Login</a>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 " data-toggle="modal" data-target="#fulfilment">
                           <a href="#" class="fulfilment logo_section"><i class="fa fa-truck fa-3x" aria-hidden="true"></i><br>Fulfilment Partner</a>
                        </div>
                     </div>
                  </div>
               </div>
