                        ...
                        <div class="col-lg-4">
                           <div class="page-header-breadcrumb">
                              <ul class="breadcrumb-title">
                                 ...
                                 <li class="breadcrumb-item"><a href="#!">All Laabh_Executive</a></li>                                
                              </ul>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="page-body">
                     <div class="card">
                        <div class="card-header">
                           <h5>All Onborded Laabh_Executive onborded by Branch Manager</h5>
                           ...
                           <tbody>
                                 ...
                                 <tr>
                                  ...
                                  <!--   <td>
                                    ...
                                    <!--<td><a href="<?php echo base_url();?>SellerRegister/seller_personal_details/<?php echo $value->seller_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light">Renew</a></td>-->
                                    <?php if($user_type==2) { ?>
                                       <td class="jsgrid-align-center ">                         
                                          <a href="<?php echo base_url();?>SellerRegister/Laabh_Executive_view/<?php echo $value->user_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>
                                    ...
                                    <?php } else if($user_type==6) { ?>
                                       <td class="jsgrid-align-center ">                         
                                          <a href="<?php echo base_url();?>Admin/Laabh_Executive_view/<?php echo $value->user_id; ?>" title="view" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>
                                         <!-- <a href="<?php echo base_url();?>SellerRegister/seller_personal_details/<?php echo $value->seller_id; ?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>-->                           
                                         <!--<a href="<?php echo base_url();?>SellerRegister/seller_personal_details/<?php echo $value->seller_id; ?>" title="Delete" onclick="confirm('Are Yoy Want To Delet This Seller!!!')" class="btn btn-sm btn-info waves-effect waves-light sellerdelet"><i class="fa fa-trash-o"></i></a>-->
                                       </td>
                                    <?php }  ?>
