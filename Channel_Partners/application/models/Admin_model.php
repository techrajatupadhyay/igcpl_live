...
/*---------------------------------------Employee---------------------------------------*/
    ...
    public function GetAllemployees()
    {
        ...
        $sql = "SELECT * FROM `users` WHERE (user_type='2' || user_type='6' || user_type='7' || user_type='8' || user_type='9' || user_type='10' || user_type='11' || user_type='12' || user_type='13') and status='ACTIVE'";
        $query = $this->db->query($sql);
	...
	public function get_employee_details($user_id,$user_type)
    {
		...
		$sql = "SELECT * FROM `users` WHERE user_id='".$user_id."' and user_type='".$user_type."'  and status='ACTIVE'";
		$query = $this->db->query($sql);
		$result = $query->result();
		//print_r($this->db->last_query());
	...
	public function get_edit_employee_details($user_id,$user_type)
    {
	...
	public function get_employee_details_mail($user_id,$id)
    {
		
		$sql = "SELECT * FROM `users` WHERE user_id='".$user_id."' and id='".$id."' and status='ACTIVE'";
		$query = $this->db->query($sql);
		$result = $query->result();
		//print_r($this->db->last_query());
	...
	public function approve_employee($user_id,$id)
    {
