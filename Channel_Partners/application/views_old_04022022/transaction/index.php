...
<html>
<head>
<script type="text/javascript" src="<?=base_url('assets/safex_pay/assets/js/jquery.min.js');?>"></script>
<script type="text/javascript" src="<?=base_url('assets/safex_pay/assets/js/bootstrap_theme.min.js');?>"></script>
<script type="text/javascript" src="<?=base_url('assets/safex_pay/assets/js/bootstrap.min.js');?>"></script>

<link href="<?=base_url('assets/safex_pay/assets/css/bootstrap-theme.min.css');?>" rel="stylesheet" />
<link href="<?=base_url('assets/safex_pay/assets/css/bootstrap.min.css');?>" rel="stylesheet" />
